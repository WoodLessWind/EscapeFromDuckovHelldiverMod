...
public class Skill_HelldiverBeaconBall : SkillBase
{
    public override void OnRelease()
    {
        ...
        Debug.Log(string.Format("投出的距离！:{0}", num));
        for (int i = 0; i < this.blastCount; i++)
        {
            ...
            Quaternion throwBeaconBallRotation = CharacterMainControl.Main.characterModel.transform.rotation;
            IsGround isGround = grenade.AddComponent<IsGround>();
    ...
    public GameObject landingBeacon;
